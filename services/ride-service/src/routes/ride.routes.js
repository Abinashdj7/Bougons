...
router.post('/', authenticate, authorize('rider'), validate('requestRide'), requestRide);
...
router.put('/:id/cancel', authenticate, validate('cancelRide'), cancelRide);
router.post('/:id/rate', authenticate, validate('submitRating'), submitRating);
